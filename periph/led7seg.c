...
void init7SegLED( void ) {
  ...
  SYSCTL[SYSCTL_RCGCGPIO] |= SYSCTL_RCGCGPIO_PORTD; //added enabling port D gate clock
  SYSCTL[SYSCTL_RCGCGPIO] |= SYSCTL_RCGCGPIO_PORTE; //added enabling port E gate clock
