 ...
 *  Modififed on: Nov 28, 2018
 *           -- add call to getID3Tags() to ensure ID3 headers are skipped
 *              prior to start of decoding
 *
 *      Author: khughes
 *
...
int MP3decode( FIL *fp ) {
  ...
  /* Be sure to position MP3 stream past any ID3 header, if any */
